...

{
  ...
  # Enable the KDE Desktop Environment.
   ...
   services.httpd.adminAddr = "tin.ho@novartis.com";
   services.httpd.documentRoot = "/var/www/html";
  ...
  environment.systemPackages = with pkgs; [
	...
	# test / demo, see services section for config rather than just install app
	#apacheHttpd
	#vsftpd 
	inetutils
